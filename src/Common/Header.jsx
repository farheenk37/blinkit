...
export default function Header() {
 ...
 <span> Delivery in 9 minutes 68,<br/> B2 Wing, Untkhana, Nagpur</span>
  </button>
  {/* <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <form>
      <input class="form-control me-2" type="search" placeholder="Search" aria-label="Search" style={{ width:'600px',backgroundColor:'#f8f8f8' }} />
      
    </form>
    <div className='d-flex justify-content-end gap-4'>
       {/* open login model */}
    <button type="button" class="btn" data-bs-toggle="modal" href="#exampleModalToggle">Login</button>
   
    <div class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalToggleLabel"  data-bs-dismiss="modal" aria-label="Close"><IoIosArrowRoundBack /></h5>
        <img src='./Login_blinkit_logo.svg' className='mx-auto'/>
      </div>
      <div class="modal-body">
       <h4 className='text-center'>India's last minute app</h4>
  ...
  <form className="text-center">
    <input 
      type="tel" maxLength={10}
       onKeyPress={(e) => {
    if (!/[0-9]/.test(e.key)) {  // sirf 0-9 allow
      e.preventDefault();
    }
  }}
    ...
    <button type="submit" className="btn btn-secondary w-100">
      ...
      <div class="modal-footer">
        <p><a href="https://blinkit.com/terms" target="_blank">By continuing, you agree to our Terms of service & Privacy policy</a></p>
...
<div class="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    ...
    {/* end login model */}
{/* Cart start offcanvas */}
   <button type="button"  class="btn btn-success btn-md " data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" ><BsCart3 color='white' size={22}/> My Cart</button>
